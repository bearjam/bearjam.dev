...
TLDR: final repo @ [GitHub](https://github.com/mysterybear/r3f-crop-example) /
[CodeSandbox](https://codesandbox.io/embed/github/mysterybear/r3f-crop-example)

This is broken down into a few commits
...
(Note: we can no longer call our image component `Image` because it will now
clash with the DOM's `Image` constructor)
