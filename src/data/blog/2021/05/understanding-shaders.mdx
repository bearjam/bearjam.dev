---
title: "Understanding Shaders"
date: 2021-05-07
author: Tom
slug: understanding-shaders
---

There are some excellent resources online for learning shaders and WebGL, namely
The Book of Shaders and WebGL Fundamentals. This post covers some of the basic
patterns that I needed to learn in order to complete
[the Dream Builder's crop implementation](link).
...
`max()`/`min()` are union/intersection.
