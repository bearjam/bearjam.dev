...
import { Step1Demo1, Step1Demo2, Step2Demo1 } from "./demos"
...
This allows us this behaviour:

<Step1Demo1 />

The same logic and behaviour can be used to pop out from any side of the
viewport:
...
## Step 3: Conditionally Render the Nav
