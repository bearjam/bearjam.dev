...
([Next.js ships its own dynamic import library](https://nextjs.org/docs/advanced-features/dynamic-import),
so we used that instead of loadable-components here; the API is practically the
same):
